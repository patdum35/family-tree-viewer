...
//  * @param {string} [config.colors.main] - Couleur principale du sélecteur
//  * @param {string} [config.colors.options] - Couleur des options
//  * @param {string} [config.colors.hover] - Couleur au survol
//  * @param {string} [config.colors.selected] - Couleur de l'option sélectionnée
//  * @param {Object} [config.dimensions] - Dimensions du sélecteur
//  * @param {string|number} [config.dimensions.width] - Largeur du sélecteur
//  * @param {string|number} [config.dimensions.height] - Hauteur du sélecteur
//  * @param {string|number} [config.dimensions.dropdownWidth] - Largeur du menu déroulant (par défaut = width)
//  * @param {string|number} [config.dimensions.dropdownMaxHeight] - Hauteur maximale du menu déroulant
//  * @param {Object} [config.arrow] - Configuration de la flèche
//  * @param {string} [config.arrow.position] - Position de la flèche: 'right' (défaut), 'left', 'center'
//  * @param {boolean} [config.arrow.visible] - Afficher la flèche (défaut: true)
//  * @param {boolean} [config.isMobile] - Indique si l'environnement est mobile
//  * @param {Function} [config.onChange] - Fonction appelée quand la valeur change
...
//     const customizeOptionElement = config.customizeOptionElement || null;
...
//         // Par défaut, utiliser le label standard
//         optionElement.textContent = opt.label;
        
//         // Si une fonction de personnalisation est fournie, l'appliquer
//         if (typeof customizeOptionElement === 'function') {
//             customizeOptionElement(optionElement, opt, index);
//         }
...
/**
 * Module amélioré pour créer des sélecteurs personnalisés avec contrôle précis de la flèche
 */
...
// /**
//  * Fonction utilitaire pour créer des options à partir de trois listes parallèles
//  * @param {Array<string>} labels - Liste des libellés courts
//  * @param {Array<string>} expandedLabels - Liste des libellés étendus
