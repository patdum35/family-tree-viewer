...
import { state, displayGenealogicTree, positionRadarButton, positionHeatMapButton, handleRootPersonChange } from './main.js';
...
import { selectFoundPerson, updateGenerations } from './eventHandlers.js';
...
export function createImageSelectorDialog(onSelect) {
    ...
    let folders = [
        `${BACKGROUND_IMAGES_PATH}highQuality`,
        // 'background_images_download'
    ];

    if (window.innerWidth < 500 || window.innerHeight < 500 ) {
       folders = [
        `${BACKGROUND_IMAGES_PATH}lowQuality`,
        // 'background_images_download'
        ];  
    }
